...
\includecode{Lazy Segment Tree}{../codes/Data_Structure/Lazy_Segtree.cpp}
\includecode{Treap}{../codes/Data_Structure/Treap.cpp}
\includecode{DSU Undo}{../codes/Data_Structure/DSU_Undo.cpp}
...
\includecode{Vertex BCC}{../codes/Graph/Bicon_CC.cpp}
...
\includecode{Dominator Tree}{../codes/Graph/Dominator_Tree.cpp}
...
\includecode{Directed MST}{../codes/Graph/Directed_MST.cpp}
\includecode{Edge Coloring}{../codes/Graph/Edge_Coloring.cpp}
...
\includecode{Farthest Pair}{../codes/Geometry/Farthest_Pair.cpp}
\includecode{Minkowski Sum}{../codes/Geometry/Minkowski_Sum.cpp}
\includecode{Circle}{../codes/Geometry/Circle.cpp}
\includecode{Delaunay Triangular}{../codes/Geometry/Delaunay.cpp}
\includecode{Half Plane Intersection}{../codes/Geometry/Half_Plane_Intersection.cpp}
\includecode{Point In Convex}{../codes/Geometry/Point_In_Convex.cpp}
\includecode{Voronoi Diagram}{../codes/Geometry/Voronoi.cpp}

\sectiontitle{String}

\includecode{KMP}{../codes/String/Kmp.cpp}
\includecode{Z Value}{../codes/String/Z.cpp}
\includecode{Suffix Array}{../codes/String/Suffix_Array.cpp}
\includecode{AC Automaton}{../codes/String/AC_Automaton.cpp}
